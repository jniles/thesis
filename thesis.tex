...
, yet the entire genome fits into a nuclear volume of $\sim374^3\mu{}m$
...
mooping and bound structures structures, the epigenetic landscape determines
...
\section{Capturing the Conformations}
...
until a population size of $\sim2.5 \times 10^7$ cells is achieved\cite{berkum2010}.
...
primers that are ligated together, allowing fine control over the amplified
sequences through primer design.  Primers are designed such that forward and
reverse 5C primers are ligated across ligation junctions in the 3C library.
...
using Next Generation Sequencing techniques (NGS).  To purify all interacting
...
derivative methods, HiC replaces the PCR methods of 3C and instead uses
steptavidin beads to pull down chimeric DNA sequences.  The captured sequences
