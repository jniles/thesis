...
simple --- to interrogate interacting regions, the experimenter attempts to
freeze the nucleus and assess contacts between regions.  To acomplish this
goal, a population of cells is cultured in appropriate medium, and fixed with
formaldehyde, a cross-linking reagent.  The overall affect of formaldehyde
fixation is to fuse together all DNA and protein structures that are nearby in
the genomic space.  Cross-linking the entire cell ensures that the nucleus is
fixed before any other experiment disruptions, exactly capturing the growing
cell's nuclear structure.  The cells are homogenized and subjected to a
restriction digest (typically with HindIII or Nco1), which leave a 5' overhang.
The overhang is filled in with a biotinylated.
