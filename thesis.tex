...
occurrences of rearrangements at specific loci may give insight into uncharacterized mechanisms that explain
macro-molecular breaks in the genome.  The canonical models for these `common fragile sites' involve spatially
...
program is not only dictated by the instruction set, but also
how the instructions are read, compiled, and executed, and is influenced
...
The simplest genomic distance measure is \textbf{Euclidean} distance.  Euclidean distance is a particular \textif{norm}, known as
...
% The H1 human embryonic stem cell line and IMR90, the human lung fibroblast cell line, were selected for analysis due to
% the abundance of publically available, high resolution interaction data.
