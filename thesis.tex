...
to strand mutations\cite{cox2012}.
...
\footnote{%
  A diploid human genome consists of two copies of the $\sim5.2MB$ DNA molecule,
...
Despite years of research trying to understand how the composition,
modification, and interactions of individual nucleosome particles, debate
persists over possible secondary structures of nucleosome arrays.  Does
another higher order structure exist above the $10-nm$ fiber?
\textit{In vitro}, nucleosome arrays suspended in ionic solution fold
naturally into a $30-nm$ fiber\cite{tremethick2007},
however, it is unclear whether this motif forms \textit{in vivo} and whether
its conformation may be different in the nuclear context\cite{bian2012}.  Even
so, the $30-nm$ firber is of particular interest to explain the highly condensed
structure of mitotic chromosomes.  The $30-nm$ fiber, if it exists, likely is
formed of nucleosomes coiled in either a solenoid or double-helix structure
(for full review, see Grigoryev and Woodcock\cite{grigoryev2012}).  Recently,
experiments using cryo-electron microscopy (cryo-EM) suggested that genome
organisation may be a fractal arrangement of $10-nm$ fibers, without invoking
a higher origanizational unit\cite{nishino2012}\cite{hansen2012}.

A critical feature of gene regulation is the ability to form long range
interactions between distal elements of the genome.

The highest level of genome organization is the chomosome neighborhood.  It is
...
\begin{table}
  \begin{tabular}{|c|*{6}{c|}}
    ...
    0.71 & 0.75 & 0.73 & 0.71 & 0.69 & \textbf{R6} \\ \hline
  \end{tabular}
