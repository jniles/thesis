...
The hypothesis that chromosomes were segregated into nuclear compartments dates back more than 100
...
the nuclear center\cite{boyle2001}\cite{frederico2006}, CTs create gene expression `pockets' with localized
...
the radial position of the chromosomes is correlated with gene density and chromosome size\cite{bolzer2006}.  



These compartments are not necessarily inherited from mother to daughter cells,
but their existence is crucial to proper mitotic chromosome formation during cell division.
There is evidence that chromosomal territories have functional roles in replication and
gene expression.  Recently, it has been shown that the distribution of chromosomal territories in the nucleus
may have profound affects on cell function in certain cell types\cite{cremer2001}.
