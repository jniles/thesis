...
\newacronym{TSS}{TSS}{Transriptional Start Site}
\newacronym[\glsshortpluralkey={GTFs}]{GTF}{GTF}{General Transcription Factor}
\newacronym{PIC}{PIC}{preinitiation complex}
\newacronym[\glsshortpluralkey={CTs},longplural={chromosome territories}]{CT}{CT}{chromosome territory}
...
\newacronym{CFS}{CFS}{chromosomal fragile sites}
...
\newglossaryentry{preinitiaton complex}{%
