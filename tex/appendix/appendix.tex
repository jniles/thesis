...
Cruz nomenclature for the NCBI Build GRCh37 published in 2009 \citep{lander2001}.
...
Imakaev and colleagues \citep{imakaev2012}.  The chimeric nature of the reads
...
Using the mapping functionality from the hiclib python package \citep{imakaev2012},
sequences from the six experimental replicates were realigned to the genome.  The
alignment employed the fast Bowtie2 alignment algorithm \citep{langmead2012}.  Once
aligned, the probes were stored as an interaction matrix in the high performance
HDF5 \citep{hdf5} data format, a total of 25Gb for all replicates.
