...
\begin{figure}[b]
  ...
  \includegraphics[width=.5\textwidth]{fig/mathemtatics/string}\label{fig:string}
\end{figure}
...
tables follows from Fienberg's work in algebraic geometry in 1970\cite{fienberg1970}. %TODO explain feinburg more
