...
increases in storage capacity and analysis speed.  Since experiments such as Hi-C produce large and larger quantities of data, researchers
...
system, called components.  The \gls{PCs} are a subset of these components that capture `most' of the variation in the data set.  It is the
