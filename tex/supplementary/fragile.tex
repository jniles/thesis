...
%Reproduced from Sutherland, 2012 \citep{sutherland2001}.

\begin{center}
\begin{longtable}{cccc}
\caption[Common Fragile Sites]{Common Fragile Sites.  Reproduced from \bibentry{sutherland2001}}\label{tab:cfs} \\

\hline \multicolumn{1}{|c|}{\textbf{Name}} & \multicolumn{1}{c|}{\textbf{Cytoband}} & \multicolumn{1}{c|}{\textbf{Class}} & \multicolumn{1}{c|}{\textbf{Type}} \\ \hline
\endfirsthead%

\multicolumn{4}{c}%
{{\bfseries \tablename\ \thetable{} -- continued from previous page}} \\
\hline \multicolumn{1}{|c|}{\textbf{Name}} &
\multicolumn{1}{c|}{\textbf{Cytoband}} &
